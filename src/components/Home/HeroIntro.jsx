    ...
    <div className="hero-intro-container">
      ...
      <section className="hero-section">
        ...
        <header className="hero-header">
          ...
          <div className="hero-auth-buttons">
            <button className="btn-login-hero">login</button>
            <button className="btn-signup-hero">signup</button>
          </div>
        </header>
      ...
      <section className="intro-section">
        ...
        <div className="intro-text">
          <p>
            MZ 세대 사이에서 '빵'은 단순한 음식이 아니라 하나의 문화 빵지순례, <br/>
            동네 숨은 빵집을 키워드로 빵집을 찾아 다니기 위한 빵(broadcast 관리) 빵집의 위치를 <br/>
            간편하게 볼 수 있고 주변의 빵집의 정보에서부터 빵 메뉴도 볼 수 있는 플랫폼을 <br/>
            여러사람들의 빵지순례 루트를보고 참고하여 자신만의 빵지순례를 만들어 공유해보아요!
          </p>
        </div>
